...
class StoriesScreen extends StatefulWidget {
  ...
  const StoriesScreen({Key? key, this.type}) : super(key: key);
  @override
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final Story story = Story.fromJson(results[index]);
                    final String imageUrl = convertImageUrl(story.thumbnail);
                    return CommonCard(
                      name: story.title,
                      imageUrl: imageUrl,
                      tag: '$imageUrl-$index',
