...
class SeriesScreen extends StatefulWidget {
  ...
  const SeriesScreen({Key? key, this.type}) : super(key: key);
  @override
              ...
              builder: (BuildContext context, AsyncSnapshot<dynamic> snapshot) {
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    final Series series = Series.fromJson(results[index]);
                    final String imageUrl = convertImageUrl(series.thumbnail);
                    return CommonCard(
                      name: series.title,
                      imageUrl: imageUrl,
                      tag: '$imageUrl-$index',
